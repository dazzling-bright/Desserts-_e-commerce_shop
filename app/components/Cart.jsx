...
function Cart({ cartSize }) {
  ...
  return (
    <section className="bg-white shadow-md rounded-lg p-3 flex self-start flex-col gap-4">
      <p>Your Cart {cartSize || "7"}</p>

      <React.Fragment>
        {cartObject.map(({ name, price, totalPrice, size }, index) => {
          return (
      ...
      <div className="grid gap-2">
        <button className="flex place-items-center rounded-xl py-3 gap-2 px-2 bg-rose-50">
          <Image
